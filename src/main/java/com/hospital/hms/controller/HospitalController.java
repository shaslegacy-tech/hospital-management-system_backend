...
public class HospitalController {
    ...
    @Operation(
        ...
        description = "Public endpoint. Creates the hospital (status " +
    ...
    public ResponseEntity<HospitalResponseDTO> registerHospital(
        ...
        log.info("Hospital {} registered, pending approval", hospital.getId());
        return ResponseEntity.status(HttpStatus.CREATED).body(toDTO(hospital));
    }
